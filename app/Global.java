...
public class Global extends GlobalSettings {
  ...
  public void onStart(Application app) {
    ...
    String adminEmail = Play.application().configuration().getString("sp.admin.email");
    String adminPass = Play.application().configuration().getString("sp.admin.pass");
    
    UserInfoDB.defineAdmin("Admin", adminEmail, adminPass);
    
    SurferFormData[] firstSurfers = {
        new SurferFormData(new Surfer(1, "Ezekiel Lau", "Honolulu, Hawaii",
        "ASP 4-Star HIC Pro Champion", "http://farm5.staticflickr.com/4073/4766299193_64be477cc8_z.jpg",
        "http://www.surfersvillage.com/img/news/57150.jpg", "Ezekiel Lau (better known as Zeke) is "
        + "coming of age as a surfer and competitor right in front of our eyes with some impressive "
        + "and creative surfing. Zeke is known for having a unique blend of style, speed, and power. "
        + "Ezekiel sets himself apart as a private school student at Kamehameha Schools (an "
        ...
        + "where she has grown (is still growing) up. At the tender age of 10 Nikki was talent spotted "
        + "by Rip Curl and in 2007 was the youngest ever State Junior Champion, taking out the "
        + "Quiksilver State Championships at just 12 years of age. At 14, Nikki won the local trials"
